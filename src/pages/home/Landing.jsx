...
import { addToSearchKeywords } from "features/filter/filterSlice";

const Landing = () => {
  const dispatch = useDispatch();
  const { keywords: searchValue } = useSelector((state) => state.filter);
        ...
        <div className="flex w-full">
          ...
          <div className="flex flex-col justify-between ">
            <div className="statCard rounded-3xl shadow-2xl p-7 bg-white relative left-[80%]">
              ...
              <p className="font-light text-gray-500">In Business Development</p>
            </div>
